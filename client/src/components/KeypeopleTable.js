    ...
    <div className="  max-w-md sm:max-w-screen-xl mx-auto px-4 md:px-8  mt-10  ">
      ...
      <div className="mt-2 shadow-sm border rounded-lg overflow-scroll h-22 ">
        <table className=" table-fixed  ">
          <thead className={`  ${isDarkMode ? "bg-black  text-white  font-semibold" : "border-b bg-gray-100 text-black font-semibold "
          }   `}>
          ...
          <tbody className={` divide-y text-sm ${isDarkMode ? "divide-slate-700 bg-gradient-to-r from-grad1 to-grad2 text-veryLight font-semibold" : "bg-white text-silver font-semibold"
          }  `}>
