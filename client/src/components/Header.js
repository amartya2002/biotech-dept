  ...
  return (
    <>
      ...
      <section className="mb-10 ">
        <nav
          className="bg-white-200 fixed top-0 w-full z-21 bg-white border-b "
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
            <header className="flex justify-between items-center h-16 ">
              <div className="flex space-x-3 ">
                ...
                <button
                className="flex-shrink-0 hover:text-blue-500 -ml-2 transition-all duration-200 ease-in-out fade-in-enter fade-in-enter-active  "
                  onClick={() => {
...
function MobileSidebar({ closeSidebar }) {
  return (
    <aside className="  mt-12 flex-col w-58 h-screen px-5 py-8 overflow-y-auto bg-white  dark:bg-gray-900 dark:border-gray-700  ">
      ...
      <div className="flex flex-col mt-4">
        <nav className="flex-1 -mx-3 space-y-4 tracking-wide leading-tight ">
          ...
          >
            ...
            <span className="mx-2 text-sm font-semibold">UG & PG Syllabus</span>
          </Link>
        </nav>
      </div>
      ...
      <button
        ...
        className="mt-5 text-silver -ml-1"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
        ...
        <div className="mb-4">
          <ul className="font-semibold text-slate-800 divide-y divide-dashed">
            <li className="p-2 hover:bg-slate-100 rounded-xl">
              ...
              <p className="font-normal text-slate-500">Go to our homepage</p>
            </li>
            <li className="p-2 hover:bg-slate-100 rounded-xl">
              <Link href="#" className="text-slate-800 hover:text-slate-900">
                About Us
              </Link>
              <p className="font-normal text-slate-500">Wanna know about us?</p>
            </li>
            <li className="p-2 hover:bg-slate-100 rounded-xl">
              <Link href="#" className="text-slate-800 hover:text-slate-900">
                Pricing
            ...
            <li className="p-2 hover:bg-slate-100 rounded-xl">
              ...
              <p className="font-normal text-slate-500">Wanna ask us out?</p>
            </li>
          </ul>
        </div>
