...
<aside
  class="   flex-col w-58 h-screen px-5 py-8 overflow-y-auto bg-white border-r dark:bg-gray-900 dark:border-gray-700 hidden  md:flex">
  <p className='text-dark'> Department. of Biotechnology</p>
   
  
  <div class="flex flex-col mt-6">
    <nav class="flex-1 -mx-3 space-y-3 ">
      <a
        class=" font-bold flex items-center px-3 py-2 text-gray-600  rounded-lg hover:bg-gray-200 hover:text-black hover:font-bold"
        href="#">
        <svg
      ...
      <a
        class="flex items-center px-3 py-2 text-gray-600  rounded-lg  hover:bg-gray-200 hover:text-black hover:font-bold  "
        href="#">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
