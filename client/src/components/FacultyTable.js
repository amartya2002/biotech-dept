...
export default () => {
    ...
    return (
        <div className="  max-w-md sm:max-w-screen-xl mx-auto px-4 md:px-8  ">
            ...
            <div className="mt-8 shadow-sm border rounded-lg  h-96  ">
                    ...
                    <tbody className="text-gray-600 divide-y">
                        {
                            tableItems.map((item, idx) => (
                                <tr key={idx}>
                                    ...
                                    <td className="px-6 py-4  text-silver font-semibold  whitespace-nowrap">{item.phone_nimber}</td>
                                    <td className="px-6 py-4 text-silver font-semibold  whitespace-nowrap">{item.position}</td>
                                    <td className="px-6 py-4 text-silver font-semibold  whitespace-nowrap">{item.salary}</td>
                                </tr>
                            ))
                        }
                    </tbody>
